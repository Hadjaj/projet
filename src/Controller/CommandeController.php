...
{
    /**
     * @Route("/commande/success", name="app_commande_sucess")
     */
    ...
    public function index(
        ...
        $facture->setUsers($this->getUsers());
        ...
        foreach ($panier as $key => $value) {
            ...
            $commandes->setProduitId($produitRepository->find($key));
            // affectation de la propriété facture issue du 
            // de la facture créé au dessus
            $commandes->setIdFacture($facture);
        ...
        $stripeSecretKey = "sk_test_51MrH65Ak5kzXl65tLEQAWfh1sfAoVFGL9Ptig4kt3jV6p3UhNZi6DfPWVUk24AzSqWjJfx08Z84S6WXfoZ0jK9gK00CnkCTigs";
